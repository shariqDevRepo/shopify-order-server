...
export default async function handler(req, res) {
    ...
    res.setHeader('Access-Control-Allow-Origin', 'https://tecnisportvzla.com'); // Allow your domain
    ...
    if (req.method === 'POST') {
        ...
        try {
            ...
            const response = await fetch('https://cace24.myshopify.com/admin/api/2025-01/orders.json', {
                method: 'POST',
                headers: {
